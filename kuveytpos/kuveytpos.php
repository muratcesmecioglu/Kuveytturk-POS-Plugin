...
function kuveytpos_init_gateway_class() {
    ...
    class WC_KuveytPos_Gateway extends WC_Payment_Gateway {
        ...
        function init_form_fields() {
            $this->form_fields = array('enabled' => array('title' => 'Aktif / Pasif', 'type' => 'checkbox', 'label' => 'KuveytTürk Sanal Pos Modülünü Aktive Edin.', 'default' => 'no'), 'merchant_id' => array('title' => 'Müşteri No', 'type' => 'text', 'description' => 'Bankanın verdiği müşteri numarası'), 'store_id' => array('title' => 'Mağaza No', 'type' => 'text', 'description' => 'Bankanın verdiği mağaza kodu'), 'api_user' => array('title' => 'API Kullanıcı Adı', 'type' => 'text', 'description' => 'Bankanın verdiği API kullanıcı adı'), 'api_pass' => array('title' => 'API Kullanıcı Şifresi', 'type' => 'password', 'description' => 'Bankanın verdiği API kullanıcı şifresi'), 'hata_donus' => array('title' => 'Hata Dönüş Sayfası', 'type' => 'select', 'options' => array('sepet' => 'Sepet', 'direkt' => 'Ödeme - Fatura Bilgileri Yok', 'odeme' => 'Ödeme - Fatura Bilgileri Var')), 'force_redirect' => array('title' => 'Banka Yönlendirme', 'type' => 'checkbox', 'label' => 'Banka yönlendirmesini zorla', 'description' => 'Bankanın 3D ödeme sayfasına otomatik yönlendirme yapılmadığı durumlarda aktifleştirin', 'default' => 'no'),);
        }
